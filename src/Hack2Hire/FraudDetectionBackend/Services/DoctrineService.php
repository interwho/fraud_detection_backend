...
class DoctrineService
{
    ...
    public function __construct()
    {
        ...
        $config = Setup::createAnnotationMetadataConfiguration(array(PATH . '/src/Hack2Hire/FraudDetectionBackend/Entities'), $autoGenerateProxy, $proxyDir);
    ...
    {
        $entityClass = 'Hack2Hire\FraudDetectionBackend\Entities\\' . $entity;
